"""Tasks: the durable record of what Yaadhamma was asked to do and how it went.

Each spoken request that needs several steps becomes a Task. Tasks are saved in
a small SQLite database (~/.yaadhamma/yaadhamma.db), so they can be listed later
...
class TaskStore:
    def __init__(self, path: Path | None = None) -> None:
        ...
        for (data,) in rows:
            ...
            task.error = task.error or "Interrupted: Yaadhamma was restarted."
